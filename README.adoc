...
+
----
echo "`minikube ip` nginx.kube.local nginx-int-monitoring.kube.local nginx-pub-monitoring.kube.local jenkins.kube.local dashboard.kube.local" >> /etc/hosts
----
+
or ...
+
----
sudo -- sh -c -e "echo '$(minikube ip) nginx.kube.local nginx-int-monitoring.kube.local nginx-pub-monitoring.kube.local jenkins.kube.local dashboard.kube.local' >> /etc/hosts"
----
...
. NGINX Internal web console is available on http://nginx-int-monitoring.kube.local
. NGINX Public web console is available on http://nginx-pub-monitoring.kube.local
